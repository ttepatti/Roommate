						...
						<section>
								<form method="post" action="#">
									<div class="row uniform 50%">
										...
										<div class="12u$">
											<ul class="actions">
												<li><form method="post"><input value="Submit" class="special" type="submit" name="submit"></form></li>
											</ul>
										</div>
									</div>
								</form>
